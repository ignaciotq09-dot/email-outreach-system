...
export function Personalize() {
  ...
  const [quickAddOptions, setQuickAddOptions] = useState<QuickAddOption[]>([
    { id: '1', label: 'Keep it under 3 sentences', checked: false },
    { id: '2', label: 'Don\'t start with "I hope this finds you well"', checked: false },
    { id: '3', label: 'Sound like a human, not a marketer', checked: false },
    { id: '4', label: 'End with one clear ask', checked: false },
    { id: '5', label: 'Avoid exclamation marks', checked: false },
    { id: '6', label: 'See fit the point in the first sentence', checked: false },
    { id: '7', label: 'Add a question to invite a reply', checked: false },
    { id: '8', label: 'No corporate buzzwords or jargon', checked: false },
    { id: '9', label: 'Keep paragraphs to 2-3 sentences', checked: false },
    { id: '10', label: 'Don\'t apologize for reaching out', checked: false },
    { id: '11', label: 'Be specific about why you\'re emailing them', checked: false },
    { id: '12', label: 'Use their first name naturally', checked: false },
  ]);
  ...
  const toggleQuickAdd = (id: string) => {
      ...
      <div className="max-w-4xl mx-auto p-4 space-y-3 relative z-10">
        ...
        <div className={`rounded-xl p-4 border ${
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div
                className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full transition-all shadow-lg flex items-center justify-center ${
          ...
          {isAIActive && (
            <div className={`mt-2.5 px-3 py-2 rounded-lg text-sm flex items-center gap-2 ${
              isDarkMode
        ...
        {selectedTab === 'writing-style' && (
          <>
            ...
            <div className={`rounded-xl p-4 border ${
              ...
              <h2 className={`text-base mb-3 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                Quick Add
              </h2>
              ...
              <div className="grid grid-cols-2 gap-2">
                {quickAddOptions.map((option) => (
                  <button
                    key={option.id}
                    onClick={() => toggleQuickAdd(option.id)}
            ...
            {/* Save Button */}
            <button className={`w-full px-5 py-2.5 rounded-lg text-sm transition-all hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 ${
              isDarkMode
