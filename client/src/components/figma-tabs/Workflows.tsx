...
import { WorkflowActiveView } from './WorkflowActiveView';
...
export function Workflows() {
  ...
  // If workflow is active, show the active view
  if (isWorkflowActive) {
    return (
      <WorkflowActiveView
        ...
        channels={channels}
        onPause={() => console.log('Pausing workflow...')}
        onStop={() => setIsWorkflowActive(false)}
        onViewStats={() => console.log('Viewing stats...')}
      />
    );
  }
  ...
  return (
    <div className={`h-full overflow-auto ${isDarkMode ? 'bg-[#0a0515]' : 'bg-slate-50'}`}>
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-4 relative z-10">
        ...
        <div className="mb-4">
          <div className="flex items-center gap-3 mb-2">
            <div className={`relative group ${isDarkMode
              ...
              } p-2 rounded-xl shadow-lg ${isDarkMode ? 'shadow-purple-500/30' : 'shadow-purple-500/20'
              }`}>
              <div className={`absolute -inset-1 rounded-xl blur-lg opacity-40 group-hover:opacity-60 transition-opacity ${isDarkMode ? 'bg-purple-500' : 'bg-purple-400'
                }`}></div>
          ...
          <div className="relative mt-4">
            <div className={`absolute -inset-1 rounded-xl blur-lg opacity-20 ${isDarkMode ? 'bg-purple-600' : 'bg-purple-500'
              }`} />
            <div className="relative flex gap-2">
              <div className="flex-1 relative">
                <Sparkles className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'
                  }`} />
                <input
                  type="text"
                  value={searchQuery}
                  ...
                  className={`w-full pl-10 pr-3 py-3 rounded-lg border-2 focus:outline-none focus:ring-2 transition-all text-sm ${isDarkMode
              ...
              <button className={`px-5 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 shadow-lg text-sm ${isDarkMode
        ...
        {/* Outreach Channels */}
        <div className={`relative rounded-xl overflow-hidden transition-all duration-500 ${isDarkMode
          ...
          <div className={`absolute top-0 right-0 w-64 h-64 rounded-full blur-[100px] pointer-events-none transition-all duration-700 ${isDarkMode ? 'bg-purple-600/10' : 'bg-purple-400/20'
            }`} />

          <div className="relative p-5">
            <div className="flex items-center gap-2 mb-4">
              <div className={`relative p-2 rounded-lg shadow-lg ${isDarkMode
                ...
                <div className={`absolute -inset-1 rounded-lg blur-lg transition-opacity ${isDarkMode ? 'bg-purple-500/40 opacity-50' : 'bg-purple-500/30 opacity-30'
                  }`} />
              ...
              {channels.map((channel) => {
                ...
                return (
                  <button
                    ...
                    className={`relative group rounded-xl p-4 transition-all duration-500 transform hover:scale-105 active:scale-95 ${channel.enabled
                      ? isDarkMode
                  ...
                  >
                    {channel.enabled && (
                      <div className={`absolute -inset-1 rounded-xl blur-xl opacity-30 group-hover:opacity-50 transition-all duration-500 ${isDarkMode ? 'bg-purple-600' : 'bg-purple-500'
                        }`} />
                    )}

                    <div className="relative flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className={`p-2 rounded-lg transition-all duration-300 ${channel.enabled
                          ? isDarkMode
                          ...
                          <Icon
                            className={`w-5 h-5 transition-colors duration-300 ${channel.enabled
                      ...
                      <div className={`relative w-11 h-6 rounded-full transition-all duration-300 ${channel.enabled
                        ? isDarkMode
                        ...
                        <div className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-md transition-all duration-300 ${channel.enabled ? 'translate-x-5' : 'translate-x-0'
                          }`} />
                      </div>
                    </div>
                  </button>
        ...
        <div className={`relative rounded-xl overflow-hidden transition-all duration-500 ${isDarkMode
          ...
          <div className={`absolute bottom-0 left-0 w-64 h-64 rounded-full blur-[100px] pointer-events-none transition-all duration-700 ${isDarkMode ? 'bg-indigo-600/10' : 'bg-indigo-400/20'
            }`} />
          ...
          <div className="relative p-5">
              ...
              <div className="grid grid-cols-6 gap-2">
                {FREQUENCIES.map((freq) => (
                  <button
                    ...
                    className={`relative px-3 py-2 rounded-lg font-medium text-xs transition-all duration-300 ${selectedFrequency === freq.id
                      ? isDarkMode
                  ...
                  >
                    {selectedFrequency === freq.id && (
                      <div className={`absolute -inset-1 rounded-lg blur-md opacity-10 ${isDarkMode ? 'bg-purple-600' : 'bg-purple-500'
                        }`} />
                    )}
            ...
            <div className={`relative mb-4 p-3 rounded-lg border-2 transition-all ${isDarkMode
              ...
              <div className="flex items-start gap-2 relative z-10">
                <div className="relative">
                  <TrendingUp className={`w-4 h-4 relative z-10 ${isDarkMode ? 'text-green-400' : 'text-green-600'
                    }`} />
                  <div className={`absolute inset-0 rounded-full blur-sm ${isDarkMode ? 'bg-green-400/30' : 'bg-green-500/20'
                    }`} />
                </div>
              ...
              <div className="grid grid-cols-7 gap-2">
                {DAYS.map((day) => (
                  <button
                    ...
                    className={`relative px-3 py-2 rounded-lg font-semibold text-xs transition-all duration-300 ${selectedDay === day
                      ? isDarkMode
                        ? 'bg-gradient-to-br from-purple-700/50 to-indigo-700/40 border-2 border-purple-400/60 text-purple-200 shadow-lg shadow-purple-500/25'
                        : 'bg-gradient-to-br from-purple-200 to-indigo-200 border-2 border-purple-500 text-purple-900 shadow-lg shadow-purple-500/15'
                      : isDarkMode
                ...
                <div className="flex flex-wrap gap-1.5">
                  {TIME_SLOTS.morning.map((time) => (
                    <button
                      ...
                      className={`relative px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-300 ${selectedTime === time
                        ? isDarkMode
        ...
        <div className="flex gap-3 justify-end">
          <button className={`px-5 py-2.5 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 text-sm ${isDarkMode
          ...
          <button
            ...
            className={`relative px-6 py-2.5 rounded-lg font-bold transition-all duration-300 flex items-center gap-2 overflow-hidden group shadow-lg text-sm ${isDarkMode
