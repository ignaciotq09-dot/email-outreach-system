// Inbox component - Main entry point
...
import { getStatusConfig, filterEmails, calculateStats } from './helpers';

// Re-export types for backward compatibility
export type { InboxEmail, StatusConfig, InboxStats } from './types';
...
export function Inbox() {
    ...
    const filteredEmails = filterEmails(emails, selectedTab);
            ...
            <div className="max-w-7xl mx-auto p-4 space-y-4 relative z-10">
                ...
                <div className="grid grid-cols-4 gap-3">
                    ...
                    <div className={`relative overflow-hidden rounded-xl p-4 border transition-all ${isDarkMode
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className={`text-3xl mt-1 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{stats.total}</p>
                            </div>
                    ...
                    <div className={`relative overflow-hidden rounded-xl p-4 border transition-all ${isDarkMode
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Unread</p>
                                <p className={`text-3xl mt-1 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{stats.unread}</p>
                            </div>
                    ...
                    <div className={`relative overflow-hidden rounded-xl p-4 border transition-all ${isDarkMode
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Replied</p>
                                <p className={`text-3xl mt-1 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{stats.replied}</p>
                            </div>
                    ...
                    <div className={`relative overflow-hidden rounded-xl p-4 border transition-all ${isDarkMode
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Starred</p>
                                <p className={`text-3xl mt-1 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{stats.starred}</p>
                            </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between gap-4 mb-2">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className={`inline-flex items-center gap-2 px-2.5 py-1.5 rounded-lg border text-sm ${statusConfig.bgColor} ${statusConfig.borderColor} ${statusConfig.textColor}`}>
