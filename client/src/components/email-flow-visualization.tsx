...
import { Mail, User, Sparkles, CheckCircle } from 'lucide-react';
    ...
    <div className="relative w-full h-64 flex items-center justify-center">
      ...
      <svg className="absolute inset-0 w-full h-full" viewBox="0 0 600 200" preserveAspectRatio="xMidYMid meet">
        <defs>
          ...
          <path id="flowPath" d="M 100 100 Q 200 50, 300 100 Q 400 150, 500 100" />
        </defs>
      ...
      <div className="relative z-10 flex items-center justify-between w-full max-w-xl px-8">
        ...
        >
          ...
          <span className="mt-2 text-sm text-gray-600">AI Magic</span>
        </motion.div>
        ...
        >
          ...
          <span className="mt-2 text-sm text-gray-600">Personalized</span>
        </motion.div>
