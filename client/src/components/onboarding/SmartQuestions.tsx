...
export function SmartQuestions({ onComplete, onBack }: SmartQuestionsProps) {
    ...
    // If no questions needed, show brief "all done" message and auto-proceed
        ...
        return (
            <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                    We found all the information we need from your website.
                </p>
                <Button onClick={onComplete} className="bg-violet-600 hover:bg-violet-700">
