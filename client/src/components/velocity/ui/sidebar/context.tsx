    ...
    if (isMobile) {
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent data-sidebar="sidebar" data-slot="sidebar" data-mobile="true" className="bg-sidebar text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden" style={{ "--sidebar-width": SIDEBAR_WIDTH_MOBILE } as React.CSSProperties} side={side}>
...
export { SidebarContext, useSidebar, SidebarProvider, Sidebar, SidebarTrigger, SidebarRail, SIDEBAR_WIDTH, SIDEBAR_WIDTH_ICON };
