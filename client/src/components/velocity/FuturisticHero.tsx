        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="text-sm text-white font-medium">
              Boost reply rates with AI-powered personalization
            </span>
          </motion.div>
          ...
          >
            AI-powered email campaigns that drive <span className="text-sky-600 font-semibold">higher reply rates, faster conversions</span>, and <span className="text-sky-600 font-semibold">real pipeline growth</span>.
          </motion.p>
          ...
          >
            {[
              { value: '3.2M+', label: 'emails sent so far', gradient: 'from-sky-500 to-blue-600', icon: '📧' },
              { value: '847K+', label: 'people replied', gradient: 'from-violet-500 to-purple-600', icon: '💬' },
              { value: '92K+', label: 'meetings booked', gradient: 'from-emerald-500 to-teal-600', icon: '📅' },
            ].map((stat, index) => (
              <motion.div 
                key={index}
              ...
              >
                ...
                <div className="text-display mb-1 text-white">
                  {stat.value}
                </div>
