...
const testimonials = [
  {
    quote: 'We booked 47 meetings in our first week. It felt like magic.',
    author: 'Sarah Chen',
  ...
  {
    quote: 'We have not missed a single reply in 3 months. It just works.',
...
function AnimatedCounter({ value, suffix, decimals = 0, gradient }: { value: number; suffix: string; decimals?: number; gradient: string }) {
  ...
  return (
    <div ref={ref} className={`text-display-lg bg-gradient-to-r ${gradient} bg-clip-text text-transparent`}>
      {displayValue()}
      {suffix}
    </div>
  );
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-display text-center text-gray-900 mb-4">
            People getting <span className="bg-gradient-to-r from-sky-600 to-blue-600 bg-clip-text text-transparent">replies</span>
          </h2>
        </motion.div>
