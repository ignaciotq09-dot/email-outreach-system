      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <div className="inline-block px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
            <span className="text-white text-sm">Ready to try it?</span>
          </div>
          
          <h2 className="text-display-lg text-white mb-6">
            Close more deals with <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">AI-driven outreach</span>
          </h2>

          <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
            Join teams boosting reply rates by 40%+. Free to start. No credit card.
          </p>
